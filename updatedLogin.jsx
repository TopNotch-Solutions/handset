...
import "../../../assets/style/updatedLogin.css";
        ...
        <div className="m-auto col-11 col-md-10 col-lg-6 col-xl-5 d-flex flex-column justify-content-center align-items-center">
          ...
          <div className="col-12 col-md-8 col-lg-10 position-relative p-4">
            ...
            <img
              src={iphone}
              alt="Illustration"
              className="riphone behide-image img-fluid"
            />
            <img
              src={login180}
              alt="Illustration"
            ...
            <div className="p-4 position-relative  p-lg-4 p-xxl-5 rounded-3 bg-white shadow">
              <form onSubmit={handleSubmit}>
                ...
                <p className="pb-3">Enter your email & password to login</p>
                <div className="form-group pb-3">
                  ...
                  <input
                    ...
                    placeholder="nmwanyangapo@mtc.com.na"
                    autoComplete="off"
                    name="email"
                    onChange={(e) => {
                      setEmailError("");
